...
The 13th value is `0x1ddd256d6afc84e8`. We can see that the random value is the first 4 bytes of the 13th value.

We can access the 13th value using the syntax `%13$p`. Then we convert the value into integer and pass it into `handle_admin()` function.
